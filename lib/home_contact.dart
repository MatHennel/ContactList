...
class _HomeContactState extends State<HomeContact> {
  ...
  final senhaUserControl = TextEditingController();
  ...
  Future<void> addUser(String id, String name, String email,String senha) async {
  ...
  Future<void> editUser(UserModel user) async {
    ...
    senhaUserControl.text = user.senha;
  }
